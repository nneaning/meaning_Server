module.exports = {
  ...
  GET_PROFILE_SUCCESS: '프로필 가져오기 성공',
  GET_PROFILE_FAIL: '프로필 가져오기 실패',
  ...
  /* Recommend */
  GET_RECOMMEND_VIDEO_FAIL: '추천 비디오를 가져오는 것에 실패했습니다.',
  GET_RECOMMEND_VIDEO_SUCCESS: '추천 비디오를 가져오는 것에 성공했습니다.',

  /* LIKE */
  SAVE_LIKE_SUCCESS: '좋아요, 별로에요 반영에 성공했습니다.',
